...
import { ReverendChatWindow } from './ReverendChatWindow';
import { useUserStore } from '@/stores/userStore';
import Pusher from 'pusher-js';
import { getCookie } from 'cookies-next';

export function ReverendMessengerButton() {
  ...
  return (
    <div className="fixed bottom-20 right-20 z-50">
      {isOpen ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-[380px] h-[350px] mb-16">
          ...
          <ReverendChatWindow onMessageRead={fetchUnreadCount} />
        </div>
      ) : (
        <Button
          size="lg"
